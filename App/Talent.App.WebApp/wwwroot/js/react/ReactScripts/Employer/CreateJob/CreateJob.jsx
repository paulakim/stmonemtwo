...
export default class CreateJob extends React.Component {
    ...
    loadData() {
        ...
        if (param != "" || copyJobParam != "") {
            ...
            var link = param != "" ? 'http://talentservicestalentpaula.azurewebsites.net/listing/listing/GetJobByToEdit?id=' + param
                : 'http://talentservicestalentpaula.azurewebsites.net/listing/listing/GetJobForCopy?id=' + copyJobParam;
    ...
    addUpdateJob() {
        ...
        $.ajax({
            ...
            url: 'https://talentservicestalentpaula.azurewebsites.net/listing/listing/createUpdateJob',
            headers: {
                'Authorization': 'Bearer ' + cookies,
                'Content-Type': 'application/json'
            },
