...
export default class AccountProfile extends React.Component {
    ...
    loadData() {
        ...
        $.ajax({
            ...
            url: 'https://talentservicesprofilepaula.azurewebsites.net/profile/profile/getTalentProfile',
            headers: {
    ...
    saveProfile() {
        ...
        $.ajax({
            ...
            url: 'https://talentservicesprofilepaula.azurewebsites.net/profile/profile/updateTalentProfile',
            headers: {
                'Authorization': 'Bearer ' + cookies,
                'Content-Type': 'application/json'
            },
                                    ...
                                    <div className="ui grid">
                                        ...
                                        >
                                            <Language
                                                ...
                                                updateProfileData={this.updateAndSaveData}
                                                upwithoutsaveData={this.updateWithoutSave}
                                        ...
                                        >
                                            <PhotoUpload
                                                ...
                                                imageSource={this.state.profileData.profilePhotoUrl}
                                                updateProfileData={this.updateWithoutSave}
                                                savePhotoUrl='https://talentservicesprofilepaula.azurewebsites.net/profile/profile/updateProfilePhoto'
                                            />
                                        </FormItemWrapper>
                                        <FormItemWrapper
                                            title='Profile Video'
                                        ...
                                        >
                                            <VideoUpload
                                                ...
                                                updateProfileData={this.updateWithoutSave}
                                                saveVideoUrl={'https://talentservicesprofilepaula.azurewebsites.net/profile/profile/updateTalentVideo'}
                                            />
                                        </FormItemWrapper>
                                        <FormItemWrapper
                                            title='CV'
                                        ...
                                        >
                                            <CVUpload
                                                ...
                                                updateProfileData={this.updateWithoutSave}
                                                saveCVUrl={'https://talentservicesprofilepaula.azurewebsites.net/profile/profile/updateTalentCV'}
                                            />
                                        </FormItemWrapper>
                                    </div>
                                </form>
