...
class ClientProfileModal extends React.Component {
    ...
    loadData(id) {
        if (id != undefined) {
            ...
            $.ajax({
                ...
                url: 'https://talentservicesprofilepaula.azurewebsites.net/profile/profile/getEmployerProfile?id=' + id + '&role=' + 'employer',
                headers: {
    ...
    saveData() {
        ...
        $.ajax({
            ...
            url: 'https://talentservicesprofilepaula.azurewebsites.net/profile/profile/saveClientProfile',
            headers: {
                'Authorization': 'Bearer ' + cookies,
                'Content-Type': 'application/json'
            },
